...
/* Dark theme overrides must be global to affect ECharts tooltip DOM */
:global(.chart-tooltip--dark .tt-title) {
  color: rgba(255, 255, 255, 0.85);
}

:global(.chart-tooltip--dark .tt-title--fmt) {
  color: #E6F0FF;
}

:global(.chart-tooltip--dark .tt-row .tt-name) {
  color: #E6F0FF;
}

:global(.chart-tooltip--dark .tt-row .tt-unit) {
  color: rgba(255, 255, 255, 0.7);
}

:global(.chart-tooltip--dark .tt-row),
:global(.chart-tooltip--dark .tt-row td),
:global(.chart-tooltip--dark .tt-table) {
