import{I as e,g as t,p as n}from"./runtime-core.esm-bundler-yhW9eEjO.js";import"./pie02-CKDMCYh5.js";import"./useCharts-Bk2f4Jhc.js";var r={class:`markdown-body`},i={__name:`README`,setup(i,{expose:a}){return a({frontmatter:{}}),(i,a)=>(e(),n(`div`,r,[...a[0]||=[t(`<h1>PdCharts</h1><p>Pandora2 的图表组件，基于 ECharts 封装，核心目标：</p><ul><li>提供一个统一的 <code>&lt;Charts&gt;</code> 组件，约定 <code>data + chartType + subChartType</code> 即可渲染常见图表</li><li>通过 <code>useCharts()</code> 暴露 ECharts 实例的常用控制能力（setOptions / resize / loading / clear / dispose 等）</li></ul><h2>快速开始</h2><h3>组件使用</h3><pre><code class="language-vue">&lt;template&gt;
...
/&gt;
</code></pre>`,20)]]))}};export{i as default};