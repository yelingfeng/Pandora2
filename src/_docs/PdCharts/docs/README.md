...
完整类型：`ChartsProps`（见 [types/index.ts](file:///Users/xiaofanren/ylf/github/Pandora2/packages/components/PdCharts/src/types/index.ts)）
...
通过 `useCharts` 可以更灵活地控制 ECharts 配置、loading、resize 等。
