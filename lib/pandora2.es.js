...
const PandoraContainer = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]), PdContainer = withInstall(PandoraContainer), Plugins = [PdContainer], installer = makeInstaller([...Components, ...Plugins]);
function isProdMode() {
  return !0;
}
function useForm(e) {
...
const install = installer.install, version = installer.version;
export {
  PdContainer,
  PdForm,
  PdFormItem,
